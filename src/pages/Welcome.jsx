...
const Welcome = ({handleClose}) => {
    ...
    return (
        <div className="min-h-screen flex overflow-hidden relative bg-white">
            <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 w-[36rem] h-[36rem] opacity-0 rounded-full animate-[rainbow_0.75s_3.25s_linear_infinite]"></div>
            ...
            <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 bg-white w-[36.1rem] h-[36.1rem] rounded-full animate-[circle_1s_3.25s_ease-out_forwards]" onAnimationEnd={() => removeWelcome()}></div>
        </div>
    )
};
